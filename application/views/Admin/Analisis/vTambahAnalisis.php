					...
					<form action="<?= base_url('Admin/cPengelola/create') ?>" method="POST" class="form-horizontal">
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="date" class="form-control" id="fname" placeholder="Masukkan Nama Pengelola">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="alamat" class="form-control" id="lname" placeholder="Masukkan Nilai Pakan Bebek">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="alamat" class="form-control" id="lname" placeholder="Masukkan Umur Bebek">
									<?= form_error('alamat', '<small class="text-danger">', '</small>'); ?>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input type="text" name="alamat" class="form-control" id="lname" placeholder="Masukkan Nilai Jenis Indukan">
									<?= form_error('alamat', '<small class="text-danger">', '</small>'); ?>
								</div>
							</div>
